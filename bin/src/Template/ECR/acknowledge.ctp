        ...
        <div class=" button-bottom clearfix">
            <div class="col-sm-12">
                <div class="pull-right">
                    <form id="ecr-acknowledge" method="post" action="<?php echo $this->Url->build(['controller' => 'ECR', 'action' => 'edit', $eCR->id]); ?>">
                        <input type="hidden" name="stat" value="acknowledged">
                        <input type="hidden" name="acknowledged_by" value="eng-manager">
                    </form>
                    ...
                    <button type="submit" form="ecr-acknowledge" class="btn btn-info btn-info-view text-uppercase">Acknowledge</button>
                    <button type="submit" class="btn btn-info btn-info-view text-uppercase" data-toggle="modal" data-target="#myModal">Reject</button>
                </div>
            </div>
        </div>
    </div>
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <textarea name="" id="model-popup" class="form-control"cols="30" rows="10"></textarea>
              </div>
