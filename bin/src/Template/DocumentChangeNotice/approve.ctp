        ...
        <div class=" button-bottom padding-top-20 clearfix">
            <div class="col-sm-12">
                <div class="pull-right">
                    ...
                    <button type="submit" form="form-data" class="btn btn-info btn-genarate color-red text-uppercase">Approve</button>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo $this->Url->build(['controller' => 'DocumentChangeNotice', 'action' => 'editMd',$documentChangeNotice->id]); ?>" method="post" enctype="multipart/form-data">
