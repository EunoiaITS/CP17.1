                ...
                <div class="pull-right">
                    <div class="fade">
                        <form id="form-data" action="<?php echo $this->Url->build(['controller' => 'PurchaseRequisition', 'action' => 'edit',$purchaseRequisition->id]); ?>" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="acknowledgement_by" value="<?php echo $pic; ?>"/>
                            <input type="hidden" name="status" value="acknowledged"/>
                        </form>
                    </div>
                    <button type="submit" form="form-data" class="btn btn-info btn-genarate color-red text-uppercase">Acknowladge</button>
