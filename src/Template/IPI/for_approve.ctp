                    ...
                    <table class="table table-bordered">
                        ...
                        <?php foreach($iPI as $iPI): ?>
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        <li><a href="<?php echo $this->Url->build(['controller' => 'IPI', 'action' => 'approve', $iPI->id]); ?>"><img class="img-icon" src="<?php echo $this->request->webroot.'assets/img/search.png'; ?>" alt=""></a></li>
