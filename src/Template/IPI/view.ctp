                ...
                <form action="#">
                    ...
                    <div class="requested-by">
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <span class="text-center-ack">Confrimed by</span>
                                <div class="approve-name">
                                    <div class="col-sm-4">
                                        <span>Name <span class="project-name-sem name-main-dr">:</span></span>
                                    </div>
                                    <div class="col-sm-8">
                                        <span class="text-uppercase"><?= h($iPI->confirmed_by) ?></span>
                                    </div>
                                </div>
                                <div class="approve-name">
                                    <div class="col-sm-4">
                                ...
                                <div class="approve-name">
                                    ...
                                    <div class="col-sm-8">
                                        <span class="text-uppercase"><?php echo date('Y-m-d', strtotime($iPI->modified)); ?></span>
                                    </div>
                                </div>
                            </div>

                            <div class="col-sm-2">
                                <span class="text-center-ack">Status</span>
                                <h2 class="text-center" style="margin:20px 0px;"><?= h($iPI->stat) ?></h2>
                                <p class="text-center">Date: <?php echo date('Y-m-d', strtotime($iPI->modified)); ?></p>
                            </div>
                        </div>
                    </div>
