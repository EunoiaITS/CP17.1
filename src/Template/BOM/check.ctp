    ...
    <div class="container">
        <div class="row">
            ...
            <div class="add-button pull-right">
                <form id="bom-check" method="post" action="<?php echo $this->Url->build(['controller' => 'BOM', 'action' => 'edit', $bOM->id]); ?>">
                    <input type="hidden" name="stat" value="checked">
                    <input type="hidden" name="checked_by" value="eng-manager">
                </form>
                ...
                <button type="submit" form="bom-check" class="btn btn-info color-red text-uppercase">Check</button>
